      ...
      <div style={{ 
        ...
        <div style={{ flex: 1, lineHeight: "1.8", fontSize: "1.05rem" }}>
          ...
          <div id="data" className="policy-section" style={{ marginBottom: "4rem" }}>
            ...
            <p style={{ color: "#cbd5e1", marginBottom: "1.5rem" }}>We may collect and process the following data about you:</p>
            ...
            <div style={{ display: "grid", gap: "1rem" }}>
              {[
                ...
                <div key={i} style={{ 
                  ...
                  <div>
                    <strong style={{ display: "block", color: "#f8fafc", marginBottom: "0.25rem" }}>{item.title}</strong>
          ...
          <div id="usage" className="policy-section" style={{ marginBottom: "4rem" }}>
            ...
            <ul style={{ color: "#cbd5e1", paddingLeft: "1.5rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <div id="thirdparty" className="policy-section" style={{ marginBottom: "4rem" }}>
            ...
            <p style={{ color: "#cbd5e1", background: "rgba(245,158,11,0.05)", borderLeft: "4px solid #f59e0b", padding: "1.5rem", borderRadius: "0 12px 12px 0" }}>
